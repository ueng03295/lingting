...
pub struct AudioChunk {
    ...
    /// If true, this is a streaming/partial chunk — audio sent before VAD finalization.
    /// The transcription result for this chunk should be emitted with is_partial=true.
